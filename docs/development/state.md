...
*Last bumped: 2026-04-28 (v1.2.0 — `--regex=<flavor>` modifier on the four pattern verbs + `--replace-files[-all]` + cyrius 5.7.23 / Pike NFA stdlib regex engine consumed)*
