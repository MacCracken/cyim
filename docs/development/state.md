...
**Current cycle: 1.9.x — open.** The 1.8.x cycle closed cleanly at 1.8.7 ([closeout audit](../audit/2026-08-23-1.8x-closeout.md)); **1.9.0** opened the line with `o` / `O`, and **1.9.1 closed BUG-002** — the LSP client works for the first time since the 1.4.0 fold-in, via a tag bump with no cyim source change.
