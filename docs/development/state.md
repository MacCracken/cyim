...
*Last bumped: 2026-05-06 (v1.3.3 — **BUG-001 closed**. Cyrius pin 5.9.2 → 5.9.13 picks up the upstream `args_init()` fix (5.9.5: heap-backed 2 MB buffer); cyim's `_cli_args_reload_big()` workaround retired. Pure code-removal cut.)*
